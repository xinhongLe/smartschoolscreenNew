                            ...
                            itemStyle: {
                                normal: {
                                    color: new echarts.graphic.LinearGradient(
                                        ...
                                        1,
                                        [
                                            { offset: 0, color: "#30A3FD" },
                                            { offset: 0.2, color: "#30A3FD" },
                                            { offset: 1, color: "#376DCC" }
                                        ]
                                    )
                                }
                            }
                            ...
                            itemStyle: {
                                normal: {
                                    color: new echarts.graphic.LinearGradient(
                                        ...
                                        1,
                                        [
                                            { offset: 0, color: "#F8F9FB" },
                                            { offset: 1, color: "#9AAFC5" }
                                        ]
                                    )
                                }
                            }
