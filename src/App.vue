<template>
    <div id="app">
        <div class="container">
            <Title :title="`*州市教育信息化数据大屏`" :style="{position: ['teachingEvaluation','evaluationData','schoolBasic', 'areaResource', 'schoolSecurity', 'lessonData', 'educationData', 'areaEducationData', 'teacherBasic', 'studentBasic','behavior'].indexOf($route.name) > -1 ? 'relative' : 'absolute'}" />
